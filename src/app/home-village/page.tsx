...
export default async function HomeVillage() {
  ...
  return (
    <Flex gap='md' direction='column' align='center'>
      <CategoryInfo
        title='Родная деревня | Вики'
        description='ClashOfClansWiki.ru представляет вики по родной деревне в Clash of Clans. Узнайте всё о защите, ресурсах, армии и тактиках для вашей деревни.'
      />
